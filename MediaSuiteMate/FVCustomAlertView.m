...
+ (UIView*)showAlertOnView:(UIView *)view
                   ...
                   type:(FVAlertType)type
{
    ...
    titleLabel.frame = CGRectMake(width/2 - requiredSize.width / 2, kInsetValue+10, requiredSize.width, requiredSize.height);
    ...
    content.frame = CGRectApplyAffineTransform(content.frame, CGAffineTransformMakeTranslation(width/2 - content.frame.size.width/2, titleLabel.frame.origin.y + titleLabel.frame.size.height + kInsetValue+20));
...
+ (UIView*)showDefaultLoadingAlertOnView:(UIView *)view withTitle:(NSString *)title {
    UIView* alertView = [self showAlertOnView:view
                withTitle:title
